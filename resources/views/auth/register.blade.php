...
<head>
    ...
    <title>Reģistrēties - Muitas CRM</title>
                        ...
                        <form method="POST" action="{{ route('register.post') }}">
                            ...
                            <div class="mb-3">
                                <label for="full_name" class="form-label">
                                    <i class="fas fa-id-card"></i> Pilnais vārds
                                </label>
                            ...
                            <div class="mb-3">
                                <label for="password_confirmation" class="form-label">
                                    <i class="fas fa-lock"></i> Apstiprināt paroli
                                </label>
